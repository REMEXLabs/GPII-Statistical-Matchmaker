...
stat.match = function (requestProxy, originalModel) {
	// Rejection tests
	if (!("deviceReporter" in originalModel)) { fluid.log("Invalid SMM payload: 'deviceReporter' missing."); };
	if (!("solutions" in originalModel.deviceReporter)) { fluid.log("Invalid SMM payload: 'deviceReporter.solutions' missing."); };
	var solutions = originalModel.deviceReporter.solutions;
	if (!("preferences" in originalModel)) { fluid.log("Invalid SMM payload: 'preferences' missing."); };
	var preferences = originalModel.preferences;
